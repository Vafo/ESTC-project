...
uint8_t message_core_process_message(message_core_t *msg_core);
uint8_t message_core_enqueue_message(message_core_t *msg_core, message_obj_t *message);
